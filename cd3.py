"""
    Name: John Huynh
    GT ID: XX3956035
    Dataset: Chinese numbers - k-nearest neighbors
    Assignment: 1
...
clf10 = Pipeline(steps=[("scaler", StandardScaler()), ("knn", KNeighborsClassifier(n_neighbors=10))])
clf15 = Pipeline(steps=[("scaler", StandardScaler()), ("knn", KNeighborsClassifier(n_neighbors=15))])
...
train_sizes, _, test_scores_10, fit_times_10, score_times_10 = learning_curve(
    clf10, **common_params
)
train_sizes, _, test_scores_15, fit_times_15, score_times_15 = learning_curve(
    clf15, **common_params
)
...
for ax_idx, (fit_times, score_times, estimator) in enumerate(
    zip(
        [fit_times_10, fit_times_15],
        [score_times_10, score_times_15],
        [clf_10, clf_15],
    )
):
