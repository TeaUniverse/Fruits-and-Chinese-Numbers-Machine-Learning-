"""
    Name: John Huynh
    GT ID: XX3956035
    Dataset: Fruits - support vector machines
    Assignment: 1
...
#import plot_model_complexity_influence as pmci
...
def svm1(kernel, X_train, X_test, y_train, y_test):
...
# kernel =
#svm1('rbf', X_train, X_test, y_train, y_test)

# kernel = 'poly'
#svm1('poly', X_train, X_test, y_train, y_test)
...
y = list(itertools.chain(y_train, y_test))
#X = X_train.extend(X_test)
#y = y_train.extend(y_test)
...
configurations = [
    ...
    {
        "estimator": SVC,
        "tuned_params": {"gamma": 2**-15},
        "changing_param": "C",
        "changing_param_values": [0.20, 0.40, 0.60, 0.80, 1.0],
